...
\author[Guss \& Zhong et. al]{\includegraphics[height=2cm,width=2cm]{BlueGold_fill_small.png}\\   Guss,  Zhong  \\ Kuznetsov,  Singhal,\ Kumar,  Golmant, Johansen,  Bartlett}
...
\begin{frame}
  ...
  \textbf{Deep Reinforcment Learning is good, but not biologically plausible.} \\
  \begin{center}
  \includegraphics[width=\textwidth]{doom.png}
  \end{center}
  \textbf{Reinforcement Learning is biologically plausble.}
    \begin{center}
  \includegraphics[width=0.3\textwidth]{dope.png}
  \end{center}
\end{frame}
